const CardRepos = ({ name, language, visibility, url, forks }) => {
	return (
		<div className='container p-2 mx-3 my-4 border rounded-md shadow sm:w-5/12 xl:w-3/12'>
			...
			<a
				className='block p-3 mt-5 text-center border-2 hover:bg-black hover:text-white'
				href={url}
				target='_blank'
				rel='noreferrer'
			>
